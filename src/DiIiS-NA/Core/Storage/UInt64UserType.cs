...
{
	/// <summary>
	/// Dialect-neutral NHibernate user type that maps CLR <see cref="UInt64"/> to the
	/// underlying SQL <c>BIGINT</c> (signed) column, which is required because standard
	/// ADO.NET drivers do not natively handle unsigned 64-bit integers.
	/// </summary>
