...
DiIiS is an open-source, non-commercial local server emulator for **Diablo III: Reaper of Souls** (client version **2.7.4.84161**). It is written in **C# / .NET 7** and provides a fully self-hosted game server including authentication, lobby, dungeon generation, item generation, AI, quests, and multiplayer (LAN) support.
...
1. Use Diablo III client **2.7.4.84161**.
